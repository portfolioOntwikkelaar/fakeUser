...
const defaultImage = 'https://randomuser.me/api/portraits/men/27.jpg'
function App() {
  ...
  return <main>
    <div className="block bcg-black cartoon"></div>
    <div className="block">
      <div className="container">
        <img src={(person && person.image) || defaultImage} alt="fake user" className="user-img" />
